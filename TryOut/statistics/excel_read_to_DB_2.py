...
con = sqlite3.connect('statistics_raw.sqlite')
create_query = """CREATE TABLE IF NOT EXISTS tblRawStatistics ( CASE_NUM TEXT, PRESSMARK TEXT, TITLE TEXT, UOM TEXT, VOLUME TEXT, CARD_NUM TEXT, OBJ_NAME TEXT, ACTIVITY_TYPE TEXT, OBJ_TYPE TEXT, OBJ_GROUP TEXT, EXAMINATION_DATE TEXT
);"""
insert_query = """
    INSERT INTO tblRawStatistics 
        (
        CASE_NUM, PRESSMARK, TITLE, UOM, VOLUME, CARD_NUM, OBJ_NAME, ACTIVITY_TYPE, OBJ_TYPE, OBJ_GROUP, EXAMINATION_DATE)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);
"""
